...
{
	static int i = 0;
	static float widtharray[] = new float[100];
	static float heightarray[] = new float [100];
	static float fl[] = new float[100];
	static float xxx[] = new float[100];
